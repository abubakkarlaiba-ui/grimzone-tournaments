  ...
  return (
    <nav className="sticky top-0 z-50 bg-[rgba(10,10,15,0.85)] backdrop-blur-xl border-b border-[rgba(255,255,255,0.06)]">
      <div className="max-w-6xl mx-auto px-5 flex items-center h-16">
        <Link href="/" className="text-white font-black text-xl flex items-center gap-2.5 shrink-0" style={{textShadow:'0 0 20px rgba(0,212,255,0.3)'}}>
          <span className="text-xl">⚔️</span> GrimZone
        </Link>

        <div className="hidden md:flex items-center gap-1 ml-5">
          <NavLink href="/">Home</NavLink>
          <NavLink href="/tournaments">Tournaments</NavLink>
          <NavLink href="/world-chat">World Chat</NavLink>
          ...
          <div className="hidden md:flex items-center gap-2 ml-auto mr-2">
            ...
            {balance !== null && (
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[rgba(0,212,255,0.25)] bg-[linear-gradient(135deg,rgba(0,212,255,0.12),rgba(139,92,246,0.08))] text-[#00d4ff] font-extrabold text-sm shadow-[0_0_20px_rgba(0,212,255,0.12)]">
                <span className="inline-flex items-center justify-center rounded-full bg-[linear-gradient(135deg,#ffd700,#ffaa00)] text-[#8b4513] text-[0.6rem] font-black shadow-[inset_0_-2px_3px_rgba(0,0,0,0.2),0_0_8px_rgba(255,215,0,0.5)] flex-shrink-0" style={{width:'22px',height:'22px'}}>FF</span>
        ...
        <div className="hidden md:flex items-center gap-1 shrink-0">
          {loggedIn ? (
            <>
              <Link href="/account" className="text-[#7777aa] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">My Account</Link>
              <Link href="/wallet" className="text-[#7777aa] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">Wallet</Link>
              <Link href="/host" className="text-[#2ecc71] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">Host</Link>
              <Link href="/teams" className="text-[#8b5cf6] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">Teams</Link>
              <Link href="/booking" className="text-[#7777aa] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">Book Slot</Link>
              {user?.role === 'owner' && <Link href="/owner" className="text-[#ffd700] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(255,215,0,0.06)]">👑 Owner</Link>}
              {user?.role === 'admin' && <Link href="/admin" className="text-[#8b5cf6] hover:text-[#00d4ff] px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:bg-[rgba(0,212,255,0.06)]">Admin</Link>}
      ...
      {open && (
        <div className="md:hidden bg-[rgba(10,10,15,0.98)] flex flex-col p-4 border-b border-[rgba(255,255,255,0.06)]">
          ...
          <MobileNav href="/world-chat" onClick={() => setOpen(false)}>World Chat</MobileNav>
          ...
          {loggedIn ? (
            <>
              ...
              <MobileNav href="/host" onClick={() => setOpen(false)} className="text-[#2ecc71]">Host</MobileNav>
