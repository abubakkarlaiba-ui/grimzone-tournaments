  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white pt-24 pb-16 px-5 flex flex-col">
      <div className="max-w-3xl mx-auto w-full flex flex-col flex-1">
        ...
        {msg && <div className="glass p-3 rounded-xl mb-4 text-sm text-center text-[#ff6b6b]">{msg}</div>}

        <div className="glass flex-1 rounded-xl p-4 mb-4 overflow-y-auto flex flex-col gap-2" style={{ maxHeight: '60vh', minHeight: '300px' }}>
          {messages.length === 0 ? (
            ...
            messages.map(m => (
              <div key={m.id} className="glass-hover p-3 rounded-xl">
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-6 h-6 rounded-full bg-gradient-to-br from-[#00d4ff] to-[#8b5cf6] flex items-center justify-center text-[10px] font-bold flex-shrink-0">
